...
public class MiddlewareConfiguratorTests
{
    ...
    public void Use_UnsupportedBuilderType_ThrowsNotSupportedException()
    {
        ...
        Assert.Throws<NotSupportedException>(() => new MiddlewareConfigurator<object>(builder));
    }

    [Fact]
    public void Use_UnsupportedBuilderType_WithInvalidBuilderParameter_ThrowsNotSupportedException()
    {
        var invalidBuilderInstance = new object(); // Unsupported builder type

        Assert.Throws<NotSupportedException>(() => new MiddlewareConfigurator<object>(invalidBuilderInstance));
    }
