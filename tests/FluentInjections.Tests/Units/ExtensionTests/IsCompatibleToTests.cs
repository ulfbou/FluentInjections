...
public class IsCompatibleToTests
{
    ...
    [InlineData(typeof(IServiceBindingBuilder<>), typeof(IServiceBindingBuilder<>), true)]
    ...
    [InlineData(typeof(MiddlewareConfigurator<IApplicationBuilder, IMiddlewareBinding>), typeof(NetCoreMiddlewareConfigurator), true)]
    ...
    [InlineData(typeof(IMiddlewareConfigurator), typeof(NetCoreMiddlewareConfigurator), true)]
